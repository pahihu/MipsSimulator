/*
	...
	File:                  $Source: /proj/topsy/ss98/MipsSimulator/RCS/AddressErrorStoreException.java,v $
	...
	$Log: AddressErrorStoreException.java,v $
...
import mipssimulator.MemoryException;


public class AddressErrorStoreException extends MemoryException {
	AddressErrorStoreException() { }
	AddressErrorStoreException(String s) { super(s); }
}
